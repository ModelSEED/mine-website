...
function mineDatabaseServices(url, auth, auth_cb) {
    ...
    this.batch_ms_adduct_search = function (db, text, text_type, tolerance, adduct_list, models, ppm, charge, halogens, _callback, _errorCallback) {
    return json_call_ajax("mineDatabaseServices.batch_ms_adduct_search",
        [db, text, text_type, tolerance, adduct_list, models, ppm, charge, halogens], 1, _callback, _errorCallback);
};

    this.batch_ms_adduct_search_async = function (db, text, text_type, tolerance, adduct_list, models, ppm, charge, halogens, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("mineDatabaseServices.batch_ms_adduct_search", [db, text, text_type, tolerance, adduct_list, models, ppm, charge, halogens], 1, _callback, _error_callback);
    };
