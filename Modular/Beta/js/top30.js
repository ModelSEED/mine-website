...
angular.module('app').controller('top30Ctl', function($scope,$stateParams,sharedFactory,top30Factory){
    ...
    if ($stateParams.id) {damageReactionIDs = [$stateParams.id]}
...
var operatorList = [
    ...
    "Methylation_2",
    "Heme_Oxidation_1",
    "Porphyrin_Peroxidation_1",
    "Porphyrin_Peroxidation_2",
...
var damageReactionIDs = [
    ...
    "R9cf5cea7fffa1e8885b4284892149f30893bfd49",
    "Rd455b1b2a5808b60424d344309b9941e811ce2af",
    "R0487a4f32581a2c768c9bfa832ba2781fcab0223",
    "R9c9e00139576bbf50477f5886f6b8233e2b8cf6f",
